...
setup(  
        ...
        install_requires= ['NumPy >= 1.17.0', 'SciPy >= 1.6.3', 'cython >= 0.29.23', 'pandas >= 1.0.0', 'scikit-learn >= 0.24.0', 'psutil >= 5.0.0', 'ssms >= 0.2.0'],
        setup_requires= ['NumPy >= 1.17.0', 'SciPy >= 1.6.3', 'cython >= 0.29.23', 'pandas >= 1.0.0', 'scikit-learn >= 0.24.0', 'psutil >= 5.0.0', 'ssms >= 0.2.0'],
